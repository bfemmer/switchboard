            ...
            bottomNavigationBar: BottomNavigationBar(
              ...
              items: const <BottomNavigationBarItem>[
                BottomNavigationBarItem(
                  icon: Icon(Icons.home, key: Key('home')),
                  label: 'Home',
                ),
                BottomNavigationBarItem(
                  icon: Icon(Icons.category, key: Key('categories')),
                  label: 'Categories',
                ),
                BottomNavigationBarItem(
                  icon: Icon(FontAwesomeIcons.phone, key: Key('hotlines')),
                  label: 'Hotlines',
                ),
                BottomNavigationBarItem(
                  icon: Icon(Icons.emergency, key: Key('emergency')),
                  label: 'Emergency',
                ),
              ],
