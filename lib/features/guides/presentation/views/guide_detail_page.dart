...
import 'package:switchboard/features/resources/presentation/widgets/info_card.dart';
        ...
        child: Column(
          children: [
            ...
            if (widget.guide.deployment != null)
              InfoCard(
                title: 'Deployment',
                description: widget.guide.deployment!,
              ),
            if (widget.guide.riskFactors != null)
              InfoCard(
                title: 'Recognizing Distress in Individuals with Risk Factors',
